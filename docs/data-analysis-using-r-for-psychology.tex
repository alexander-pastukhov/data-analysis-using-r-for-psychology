...
Trying to extract multiple items, use of negative or zero indexes fill all fail for \emph{simplifying} subsetting.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# "attempt to select more than one element in vectorIndex" error}
\NormalTok{x[[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{]]}

\CommentTok{\# technically, we are excluding two out of three indexes, so end up with just one value}
\CommentTok{\# still, "attempt to select more than one element in vectorIndex"}
\NormalTok{x[[}\SpecialCharTok{{-}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{)]]}

\CommentTok{\# A different error message: "attempt to select less than one element in get1index \textless{}real\textgreater{}"}
\NormalTok{x[[}\DecValTok{0}\NormalTok{]]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# this also works but strips the name off}
\NormalTok{x[[}\StringTok{"a"}\NormalTok{]]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# this fails silently by returning NA}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# this will generate a "subscript out of bounds" error}
\NormalTok{x[[}\StringTok{"d"}\NormalTok{]]}
\end{Highlighting}
\end{Shaded}
...
Using multiple, negative or zero indexes will fail just like it does for vectors but \emph{some} error messages will be different.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# "subscript out of bounds" error}
\NormalTok{l[[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{]]}

\CommentTok{\# technically, we are excluding two out of three indexes, so end up with just one value}
\CommentTok{\# still, "attempt to select more than one element in integerOneIndex"}
...
\textbf{General rule:} use \texttt{{[}{[}{]}{]}} if you are interested in list or table content, e.g., you need a column from the table. Use \texttt{{[}{]}} if you interested in using a smaller list or table.
...
\section{Subsetting table}\label{table-subsetting}}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-95-1.pdf}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-96-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-97-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-98-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-99-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-102-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-140-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-147-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-155-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-156-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-157-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-160-1} \end{center}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-171-1.pdf}
...
\hline
1 & M-1 & Symmetry & 6 & 1.31\\
\hline
1 & M-1 & Attractiveness & 4 & 1.00\\
\hline
1 & M-1 & Trustworthiness & 3 & 2.13\\
\hline
1 & M-2 & Symmetry & 4 & 1.19\\
\hline
\end{tabular}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-185-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-186-1} \end{center}
...
\begin{verbatim}
##  [1]  0.0000000 -0.2489183  1.2598888  3.0580159 -0.5200782  0.4978765
##  [7]  2.3733759  4.7874624  6.2336181  4.9094231
\end{verbatim}
...
\begin{verbatim}
##           [,1]       [,2]       [,3]       [,4]
## [1,] 0.1928778  0.8531005 -0.4561584 -0.3985552
## [2,] 0.3572293  0.4078962 -1.9254403  0.2442437
## [3,] 1.0628041 -0.4929764 -0.2296072  1.5260806
\end{verbatim}
...
\begin{verbatim}
## [1] -0.1028387  0.3007365  0.4165985
\end{verbatim}
...
\begin{verbatim}
## [1]  0.3572293  0.4078962 -0.4561584  0.2442437
\end{verbatim}
...
## 
## data:  df$x and df$y
## t = 22.585, df = 98, p-value < 2.2e-16
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-237-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-239-1.pdf}
...
\NormalTok{df\_group }\OtherTok{\textless{}{-}}
  \FunctionTok{tibble}\NormalTok{(}\AttributeTok{x =} \FunctionTok{c}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{x, df}\SpecialCharTok{$}\NormalTok{y),}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-247-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-252-1.pdf}
...
\addcontentsline{toc}{subsection}{Read files and preprocess data}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-270-1.pdf}
...
\addcontentsline{toc}{subsection}{Computing the score}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-285-1.pdf}

\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-286-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-295-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-296-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-300-1.pdf}

\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-301-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-308-1.pdf}

There seems to be clear outliers, so let us drop all values above 1000 (filter inside the ggplot call) and plot again

\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-309-1.pdf}
