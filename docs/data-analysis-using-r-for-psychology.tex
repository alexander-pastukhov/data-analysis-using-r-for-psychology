...
You can specify the order of levels either during the \texttt{factor()} conversion call or later using \href{https://forcats.tidyverse.org/}{forcats} library (more on that later). For example, if we want to have levels in the reverse order we specify it via \texttt{levels} parameter. Note the opposite order of levels.
...
We can also specify \texttt{labels} of individual labels instead of using values themselves. Note that the labels must match levels in number and order.
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-180-1} \end{center}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-183-1.pdf}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-197-1} \end{center}
...
\begin{center}\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-198-1} \end{center}
...
\begin{verbatim}
##  [1]  0.000000  1.208167  7.371090  7.814418  4.191588  5.661427  5.313030
##  [8]  6.864654  9.959652 13.031879
\end{verbatim}
...
\begin{verbatim}
##            [,1]        [,2]       [,3]       [,4]
## [1,] -0.3449145  1.05804468 -0.8904780  0.5272834
## [2,]  0.8106965  0.10981307  0.8418642 -0.6198217
## [3,]  0.6018771 -0.01558582 -0.6662144 -0.6133678
\end{verbatim}
...
\begin{verbatim}
## [1]  0.09118444  0.46025481 -0.31447680
\end{verbatim}
...
\begin{verbatim}
## [1]  0.6018771  0.1098131 -0.6662144 -0.6133678
\end{verbatim}
...
## 
## data:  df$x and df$y
## t = 23.625, df = 98, p-value < 2.2e-16
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-249-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-282-1.pdf}

\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-283-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-297-1.pdf}

\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-298-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-312-1.pdf}

\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-313-1.pdf}
...
\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-320-1.pdf}

There seems to be clear outliers, so let us drop all values above 1000 (filter inside the ggplot call) and plot again

\includegraphics{data-analysis-using-r-for-psychology_files/figure-latex/unnamed-chunk-321-1.pdf}
