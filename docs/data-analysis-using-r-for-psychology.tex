...
\hypertarget{tibble-a-better-data.frame}{%
\section{Tibble, a better data.frame}\label{tibble-a-better-data.frame}}

\hypertarget{tribble-table-from-text}{%
\section{Tribble, table from text}\label{tribble-table-from-text}}

\hypertarget{reading-example-tables}{%
\section{Reading example tables}\label{reading-example-tables}}

\hypertarget{reading-tables-from-disk}{%
\section{Reading tables from disk}\label{reading-tables-from-disk}}
