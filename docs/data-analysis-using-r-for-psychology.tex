...
\item
  ...
  \item
    from string only it is a properly formed number, e.g.~\texttt{as.double("12.2")} → \texttt{12} but \texttt{as.double("12punkt5")} is \texttt{NA}
  \item
    from \texttt{NA} → \texttt{NA}
  \end{itemize}
\item
