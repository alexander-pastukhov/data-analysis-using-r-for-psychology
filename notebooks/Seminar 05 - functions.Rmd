...
## Exercise 01
Take a look at the function definition and fill-in the answers below
...
```{r exercise 09-1 temporary variables}
```

```{r exercise 09-2 nested calls}
```

```{r exercise 09-3 pipes}
```
...
```{r exercise 10-1 define function}
```

```{r exercise 10-2 pipe to first parameter}
```

```{r exercise 10-3 pipe to second parameter}
```

```{r exercise 10-4 pipe to third parameter}
```

```{r exercise 10-5 pipe to first and second parameter}
```

```{r exercise 10-6 pipe to second and third parameter}
```


```{r exercise 10-7 pipe to all three parameters}
```
