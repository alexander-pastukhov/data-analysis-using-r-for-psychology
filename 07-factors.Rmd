...
* [summarize](#summarize) the data by computing [number](https://dplyr.tidyverse.org/reference/context.html) of entries per group, don't forget to ungroup table (you can also [count](https://dplyr.tidyverse.org/reference/count.html?q=count()) them)
