...
First, let us make a shorter version of `mpg` table by using only the first five rows. Note, you can also pick first N rows via [head()](https://stat.ethz.ch/R-manual/R-devel/library/utils/html/head.html) function.
```{r}
short_mpg <- mpg[1:5, ]

# same "first five rows" but via head()
